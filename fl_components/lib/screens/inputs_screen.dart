...
class InputsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, String> formValues = {
      ...
      'last_name'   : 'Sánchez',
      'email'       : 'alejandrosh97@correo.ugr.es',
      'password'    : '123456',
      'role'        : 'Admin'
    };
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                CustomInputField(labelText: 'Contraseña', hintText: 'Contraseña del usuario', keyboardType: TextInputType.visiblePassword, obscureText: true, formProperty: 'password', formValues: formValues,),
                const SizedBox(height: 30,),
